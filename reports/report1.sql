select distinct C.fund_name, A.last_name, A.first_name, A.address, A.address_2, A.city, A.postal_code, A.email_address, A.contact_type, 
B.donation_date, B.type_name, D.origin_name, B.donation_notes, sum(B.donation_amt) as "donation_amt"
from dimdonortb A
